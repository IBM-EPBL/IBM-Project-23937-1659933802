...
COS_API_KEY_ID="4ztF8qT8r9GF4O_guNrikU8ithMUmNytACSX5x3tFDBI"
COS_INSTANCE_CRN="crn:v1:bluemix:public:cloud-object-storage:global:a/b70d94daa06c4707a2112c1ba2e62dcc:8fd42f1a-e49e-467f-949d-a2df5ad085a8::"
...
@app.route('/')
def index():
    files = get_bucket_contents('flask-bucket-2')
