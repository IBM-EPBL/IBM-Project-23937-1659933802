...
COS_API_KEY_ID="ia11PauC70umt0GQ7tulOIsEoZFRZCop63oit_DPdbSJ"
COS_INSTANCE_CRN="crn:v1:bluemix:public:cloud-object-storage:global:a/9a8a9e60258a487cb9908bbbb32aaa4f:edc79d5a-4cae-4f7d-ac83-d92e0e6d5902::"
...
@app.route('/')
def index():
    files = get_bucket_contents('flask-bucket-3')
